...
<div class="container marketing">
  <div class="row">
      <div class="col-lg-4">
        ...
        <img class="rounded-circle" width="140" height="140" src="/foodtasticwebapp/src/uploads/images/chianti.jpeg">
        <h2>Vin issu d'une agriculture responsable</h2>
        <p>Porfiter de nôtre meilleur sélection de vins issu d'un agriculture responsable sans OGM provenant de vignoble Sud-Africains, Belge, Français et Nord Américain.</p>
      ...
      <div class="col-lg-4">
       <img class="rounded-circle" width="140" height="140" src="/foodtasticwebapp/src/images-produits/cartgreen.png">
        ...
        <p>Veuillez bien vous enregister sur notre page avant de composer vôtre panier afin de faciliter l'élaboration de vôtre facture ou preuve d'achat.</p>
