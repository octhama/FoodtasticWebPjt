            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="/foodtasticwebapp/src/usermanagment/profil.php" class="dropdown-item"><i class="fa fa-user-o"></i> Mon profil</a></li>
                        <li><a href="/foodtasticwebapp/src/panier.php" class="dropdown-item"><i class="fab fa-opencart"></i> Panier de <?php echo $_SESSION['identifiant'];?></a></li>
                        <li class="divider dropdown-divider"></li>
                        <li><a href="/foodtasticwebapp/src/usermanagment/profil.php?logout='1'" class="dropdown-item"><i class="fas fa-sign-out-alt"></i>Déconnexion</a></li>
                    </ul>
                </li>
                <li class="nav-item">
